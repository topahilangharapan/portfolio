...
> **Summary:** Experience records generated from structured JSON for portfolio and AI/LLM consumption.
...
| Type | Internship |
| Location | WFO |
| Duration | 2025-08-18 – 2026-04-26 (Ongoing) |
| Icon | ✈️ |
...
### Technologies
Java · Spring Boot · MongoDB · Google Cloud Platform · BigQuery · Karate · Docker · Kubernetes · GitHub Copilot CLI
...
### Technologies
Spring Boot · Angular · PostgreSQL · Apache HTTP Server · Bootstrap · Docker · Kubernetes
