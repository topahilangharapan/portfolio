# CV Updates Summary - Enhanced for NTU Edge AI PhD Position

## Date: April 26, 2026

---

## Key Changes Made to CV

### 1. **Thesis Section - Added Technical Depth** ✅

**Previous:**
- Generic mention: "Implementation of Morris Mano Computer Architecture with Enhancements"
- No specific details about what enhancements were made
...
### 2. **Project Section - Reframed for Systems Focus** ✅

**Previous:**
- Section titled: "MACHINE LEARNING PROJECTS"
- Framed as "Machine Learning Analyst" role
- Emphasis on business analytics and ML algorithms only

**Updated:**
- Section titled: "RESEARCH & TECHNICAL PROJECTS"
- Framed as "Systems & ML Integration"
- Rewritten to emphasize:
  - **System design:** "end-to-end predictive analytics system"
  - **Performance considerations:** "data pipeline efficiency and model optimization"
  - **Resource constraints:** "computational efficiency trade-offs in resource-constrained scenarios"
  - **Engineering rigor:** "systematic data preprocessing," "performance evaluation methodologies"

**Impact:** Shifts perception from pure ML/AI work to systems-oriented thinking, which aligns with the position's emphasis on "systems, rather than AI."

---

### 3. **Email Draft - Enhanced Systems Research Section** ✅
...
2. ✅ **Technical Depth:** Provides concrete details about:
   - What was enhanced (datapath, control flow)
   - Why it matters (more complex operations)
...
4. ✅ **Systems vs. AI Focus:** Reframing of ML project demonstrates:
   - Understanding of system performance trade-offs
   - Focus on efficiency and scalability
   - Engineering rigor beyond algorithm selection
...
1. **Performance Metrics:** While we mention the enhancements, we don't have:
   - Clock frequency achieved
   - Resource utilization (LUTs, flip-flops used)
   - Power consumption measurements
   - Timing analysis results
   
   *Action if available:* If you have these metrics from your FPGA implementation, add them as a bullet point.

2. **Conference Paper Submissions:** Still no mention of:
   - Actual paper submissions or publications
...
## Comparison: What Professors See Now vs. Before

### Before:
- **Thesis:** Generic FPGA implementation
