...
- [ ] Research 2-3 recent papers from **NTU IoT Group** (Dr. Rui Tan) - fill in specific paper titles/topics above
- [ ] Research 2-3 recent papers from **NTU CPS Group** (Dr. Arvind Easwaran) - fill in specific paper titles/topics above
- [ ] Attach updated CV (CV_Research_Musthofa_Joko_Anggoro.pdf)
- [ ] Prepare transcripts (official if possible, unofficial if faster)
- [ ] Prepare recommendation letter from Prof. Petrus Mursanto (if available)
- [ ] Double-check email addresses: tanrui@ntu.edu.sg, arvinde@ntu.edu.sg
- [ ] Send by **April 27, 2026** (before April 30 deadline) to allow for rolling review
- [ ] Keep tone professional but genuine - show enthusiasm without overselling
- [ ] Proofread carefully - no typos allowed in a PhD application

## Tips for Customization

1. **Research their papers:** Spend 2-3 hours reading recent publications from both advisors. Mention specific papers that genuinely interest you.

2. **Be specific:** Replace generic statements with concrete examples from their work that align with your interests.

3. **Show systems thinking:** When discussing your experience, emphasize:
...
4. **Acknowledge limitations honestly:** The email above is honest about being an emerging researcher. This humility + demonstrated passion often works better than overselling.

5. **Timeline sensitivity:** They want applications by April 30, 2026, with rolling interviews. Send yours earlier (April 27-28) to show initiative and get earlier consideration.
