...
<template>
  <div class="container mx-auto px-4">
    <!-- XP Window Container -->
    <div class="xp-window max-w-6xl mx-auto">
      <!-- XP Title Bar -->
        ...
        <div class="grid lg:grid-cols-2 gap-6">
          ...
          <div>
            <div class="xp-group">
              ...
              <div class="xp-panel xp-scroll overflow-y-auto p-3">
                <div class="space-y-4">
                  ...
                  <!--                  &lt;!&ndash; Backend Technologies &ndash;&gt;-->
                  <!--                  <div>-->
                  <!--                    <h4 class="font-xp font-bold text-black text-sm mb-2 flex items-center">-->
                  ...
                  <!--                    </h4>-->
                  <!--                    <div class="flex flex-wrap gap-2">-->
                  <!--                      <span class="xp-button px-3 py-1 font-xp text-xs">Node.js</span>-->
                  <!--                      <span class="xp-button px-3 py-1 font-xp text-xs">Express.js</span>-->
                  <!--                      <span class="xp-button px-3 py-1 font-xp text-xs">REST APIs</span>-->
                  <!--                      <span class="xp-button px-3 py-1 font-xp text-xs">Firebase</span>-->
                  <!--                    </div>-->
                  <!--                  </div>-->
...
<!--                    <h4 class="font-xp font-bold text-black text-sm mb-3 flex items-center">-->
<!--                      <span class="w-3 h-3 bg-red-500 rounded-sm mr-2"></span>-->
<!--                      Proficiency Assessment-->
<!--                    </h4>-->
<!--                    <div class="space-y-3">-->
<!--                      <div>-->
<!--                        <div class="flex justify-between font-xp text-xs mb-1">-->
...
<!--                            :style="{ width: skillProgress.javascript }"-->
<!--                          ></div>-->
<!--                        </div>-->
<!--                      </div>-->
<!--                      <div>-->
...
<!--                          <div-->
<!--                            class="xp-progress-bar transition-all duration-[2000ms] ease-out"-->
<!--                            :style="{ width: skillProgress.nodejs }"-->
<!--                          ></div>-->
<!--                        </div>-->
<!--                      </div>-->
<!--                      <div>-->
...
<!--                          <div-->
<!--                            class="xp-progress-bar transition-all duration-[2000ms] ease-out"-->
<!--                            :style="{ width: skillProgress.database }"-->
<!--                          ></div>-->
<!--                        </div>-->
<!--                      </div>-->
<!--                    </div>-->
