      ...
      <div class="flex-1 overflow-hidden bg-xp-window">
        <div class="xp-scroll h-full overflow-y-auto p-4">
          <div class="grid lg:grid-cols-2 gap-6">
            ...
            <div class="xp-group">
              <div class="xp-group-title">Undergraduate Thesis</div>
              <div class="p-2 space-y-2">
                <div class="xp-panel p-3">
                  <p class="font-xp font-bold text-black leading-snug" style="font-size: 12px;">
                    Bridging the Gap Between the Mano Register-Transfer Model and FPGA Realization
                    Through a Synthesisable VHDL-93 Architecture
                  </p>
                </div>
                <div class="flex items-center gap-2">
                  <span class="font-xp text-gray-600" style="font-size: 11px;">Supervisor:</span>
                  <span class="font-xp font-bold text-black" style="font-size: 11px;">Prof. Dr. Ir. Petrus Mursanto, M.Sc.</span>
                </div>
                <div class="xp-panel-raised p-2 flex items-center gap-2">
                  <span style="font-size: 16px;">⚡</span>
                  <div>
                    <p class="font-xp font-bold" style="font-size: 12px; color: var(--xp-dark-blue);">58.648 MHz on Xilinx Spartan-3AN FPGA</p>
                    <p class="font-xp text-gray-600" style="font-size: 10px;">Full VHDL-93 hierarchical implementation · Completed June 2026</p>
                  </div>
                </div>
                <div class="flex flex-wrap gap-1 pt-1">
                  <span class="research-chip">VHDL-93</span>
                  <span class="research-chip">Xilinx ISE</span>
                  <span class="research-chip">Spartan-3AN FPGA</span>
                  <span class="research-chip">RTL Design</span>
                  <span class="research-chip">EDA</span>
                </div>
              </div>
            </div>
              ...
              <div class="xp-group h-full">
                ...
                <div class="space-y-4">
                  ...
                  <div class="space-y-3">
                    ...
                    <div>
                      <h4 class="font-xp font-bold text-black text-sm mb-2">⚙️ Systems & Hardware</h4>
                      <div class="flex flex-wrap gap-1">
                        <span class="xp-button px-2 py-1 font-xp text-xs">Computer Architecture</span>
