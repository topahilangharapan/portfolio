...
const props = withDefaults(defineProps<Props>(), {
  projects: () => [
    {
      id: '0',
      title: 'FPGA-Based Computer Architecture — Undergraduate Thesis',
      description:
        'A complete synthesisable VHDL-93 implementation of the Mano Register-Transfer model on a Xilinx Spartan-3AN FPGA, achieving 58.648 MHz clock frequency. Bridges the gap between textbook computer architecture theory and physical hardware through systematic gap analysis and hierarchical RTL design.',
      technologies: ['VHDL-93', 'Xilinx ISE 14.x', 'Spartan-3AN FPGA', 'XST Synthesizer', 'ISim/GHDL', 'Register-Transfer Level'],
      githubLink: [],
      liveDemoLink: '',
