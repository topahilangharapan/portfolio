      ...
      <div class="bg-xp-window p-4">
        ...
        <div class="flex items-center mb-3">
          ...
          <div>
            ...
            <p class="font-xp text-xs text-gray-600">Computer Architecture Researcher · PhD Aspirant</p>
          </div>
        </div>
        ...
        <div class="space-y-2 text-xs font-xp">
          ...
          <div class="flex items-start">
            <span class="text-blue-600 mr-2 font-bold">•</span>
            <span class="text-gray-700">
              Click <strong>"Start"</strong> for quick navigation · <strong>taskbar</strong> to switch windows
            </span>
          </div>
        </div>
